...
%
% This code is the function used in the Monte Carlo loop for evaluating the 
% the impact of different regularization terms and constraint in learning 
% problem 
...
% August 2022
%--------------------------------------------------------------------------
function T = LKO_comp_fun(dBvalx,MC_num)
%--------------------------------------------------------------------------
tic;
